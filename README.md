...
I'm a Computer Science student at **FIAP** (São Paulo, Brazil) with interest in **software development and cybersecurity**. I spent ~3 years in Ireland, studying at CCT College Dublin and working as a Team Leader — an experience that shaped my communication skills, adaptability and resilience.

- B.Sc. Computer Science — FIAP (2026 – 2030)
- Former student at CCT College Dublin, Ireland (2024 – 2025)
- Interested in software development and cybersecurity
- Currently learning: Python · C# · Cybersecurity
- Languages: Portuguese (native) · English — Cambridge B2 (Advanced)
...
| Connect and Protect: Networks and Network Security | Google | Completed |
| Santander Cibersegurança #2 | Santander | Completed |
| Hacker Skills | FIAP | In progress |
| Python for Everyone | Gustavo Guanabara | In progress |
| Google Cybersecurity Certificate | Google / Coursera | Paused (4/9) |
